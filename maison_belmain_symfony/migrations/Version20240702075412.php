 ...
 */
final class Version20240702075412 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD price_id INT DEFAULT NULL, ADD final_price NUMERIC(10, 2) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP price_id, DROP final_price');
    }
}
